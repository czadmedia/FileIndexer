...
interface PositionalIndexOperations : IndexOperations {
    ...
    /**
     * Get position information for a specific token in a specific file.
     * Advanced positional query capability.
     */
    fun getTokenPositions(token: String, path: Path): List<Int>?
    
    /**
     * Advanced query: find tokens within a specific distance of each other.
     */
    fun queryProximity(tokens: List<String>, maxDistance: Int): Set<Path>
    
    /**
     * Get detailed positional information for debugging.
     */
    fun dumpPositionalIndex(): Map<String, Map<Path, List<Int>>>
}